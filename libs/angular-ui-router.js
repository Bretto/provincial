      ...
      return function(scope, element, attr) {
        ...
        function updateView(doAnimate) {
          var locals = $state.$current && $state.$current.locals[name];
            ...
            if(locals && viewLocals && locals.$stateParams && viewLocals.$stateParams){
                console.log(locals.$stateParams);
                console.log(viewLocals.$stateParams);
            }

          if (locals === viewLocals) return; // nothing to do

          //TODO Super Dirty !!!!
          if(locals && viewLocals && locals.$stateParams.pageId && viewLocals.$stateParams.pageId)  {
              if ( locals.$stateParams.pageId === viewLocals.$stateParams.pageId)return;
          }
